...
PMAP_dh_nc=0.012    #the initial relative energy at t = t0, in NC coordinates
...
PMAP_n_sol=500 #number of computed trajectories
PMAP_si_min=-0.8  #minimum value for the initial conditions (s1, s3) on the map
PMAP_si_max=0.8  #maximum value for the initial conditions (s1, s3) on the map
